		...
		<div className="page">
			...
			<div>
				...
				<div className="h2" role="heading" aria-level={2}>
					Brazos Valley Council of Governments Contract Management
					System
				</div>
				<div id="bvcog">
					<img
					...
					/>
					<p className="bvcog">
						A full stack application to serve as a contract
						management system for Brazos Valley Council of
						Governments.
						<br />
						BVCOG sent contracts electronically to the
						contracts@bvcog.org email address, with very little
						description as to what the contract was about, who it
						was with, when it expired, and whether it could be
						renewed.
						<br />
						Sometimes contracts would expire without them taking the
						appropriate action, or they would continue perpetually
						on a month-to-month basis resulting in disallowed costs.
						<br />
						<br />
						Some features include an Amazon-style review system for
						vendors. Users can review vendors based on how previous
						contracts went so that better vendors can be selected in
						the future.
						<br />
						Highly-customizable reports can be generated in Portable
						Document Format for both users and contracts.
						<br />
						Uses RSpec and Cucumber to ensure test-driven
				...
				<div id="bvcog">
					<p className="bvcog">
						...
						You can watch this video below that demonstrates the
						product that a team of students and I worked on.
					</p>
				</div>
				<p className="youtube">
					<iframe
				...
				<div id="scriptsearch">
					<p className="scriptsearch">
						...
						platforms like YouTube presents a formidable challenge
						due to the limitations of traditional metadata-based
						methods.
						<br />
						These methods often struggle to capture the intricacies
						of video content accurately.
						<br />
						Additionally, the sheer amount of content uploaded to
						YouTube ensures that a comprehensively nuanced search
						would take an unreasonable amount of time and effort.
						<br />
						By storing YouTube transcripts and developing a
						dedicated website, this solution aims to enhance search
						experiences, optimizing performance while maintaining a
						...
						recall.
						<br />
						Evaluation encompasses rigorous unit testing,
						integration testing, user acceptance testing, and user
						studies to ensure both functionality and user
						satisfaction.
						<br />
						Overall, the website provides an effective tool for
						navigating and accessing video content with precision
						and ease.
						<br />
						You can view the source code for the front end{" "}
						<Link href={scriptsearch_frontend}>here</Link> and the
						back end <Link href={scriptsearch_backend}>here</Link>.
						<br />
						<img
							className="logo"
				...
				<div id="strassen">
					...
					<p className="strassen">
						...
						multiplication algorithm using OpenMP directives in
						C/C++.
						<br />
						...
						<br />
						Optimized the code to efficiently distribute workload
						across multiple threads, achieving significant speedup
						...
						performance evaluation results comprehensively for
						future reference and potential publication.
					</p>
				</div>
				...
				<div id="robomasters">
					<p className="tamu_rm">
						...
						subteam.
						<br />
						This subteam was a part of the Computer Vision team,
						which was, intern, part of TAMU RoboMasters.
						<br />
						Some of the work I did on this project can be found on
						the team&apos;s GitHub page found{" "}
						<Link href={rm_github}>here</Link>.
						<br />
						<br />
						The purpose of the simulation was to be able to emulate
						the robots developed by the team along with their
						...
						Computer Vision team as the Hardware team were working
						on the robots to make them better.
						<br />
						<br />
						To solve this problem, the CV Team created the
						Simulation SubTeam to create a simulation.
						<br />
						With this Simulation, they would hope to be able to test
						their new algorithms.
						<br />
						Some of these algorithms include, new de-noise
						algorithms, more optimal armor plate detector.
						<br />
				...
				<div id="pos">
					...
					<p className="pos">
						...
						<br />
						Finally, this project uses a weather API to display
						weather information as well as recomend certain items
						during cooler weather.
						<br />
						A custom REST API to communicate between the front-end
						and the back-end of the application.
						<br />
						<br />
						You can view the source code for this project{" "}
				...
				<div id="clip">
					<p className="clip">
						...
						<br />
						Self-supervised learning (SSL) has gained prominence for
						its ability to generalize across downstream tasks in
						areas such as natural language processing and computer
						vision.
						<br />
						Among SSL frameworks, Contrastive Learning (CL) has
						proven effective by maximizing the similarity between
						positive pairs and minimizing it between negative pairs.
						<br />
						While CLIP has demonstrated success in aligning image
						and text representations, challenges persist, such as
						slow convergence in large-scale bimodal datasets.
						<br />
						Participants are tasked with accelerating global
						contrastive loss optimization and enhancing model
						performance on provided benchmarks.
						<br />
						<br />
						Trainig of CLIP models used a 100k subset of the
						Conceptual Captions 3M dataset for training and validate
						...
						<br />
						Models are restricted to using ResNet-50 and DistilBERT
						as encoders, with fixed hyperparameters, and must
						compare at least two optimizers and three loss
						functions.
						<br />
						Deliverables include model code, trained models, and a
						detailed report covering experimental results, all
						adhering to specified guidelines.
						<br />
				...
				<div id="clip">
					<p className="clip">
						The following video presents the results of this
						project.
						<br />
				...
				<div id="mpm">
					...
					/>
					<p className="mpm">
						Developed a predictive in-hospital mortality model
						utilizing a dataset of several thousand patients.
						<br />
						...
						Gradient Boosting to compare against the
						Professor&apos;s Model.
						<br />
						The model had a final Area Under the Receiver Operating
						Characteristic curve (AUC-ROC) Score of 0.89288 which
						was 5% better than the Professor&apos;s Model.
						<br />
