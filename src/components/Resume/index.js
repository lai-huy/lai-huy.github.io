...
import distinguished from "../../assets/FALL 2022 Distinguished Cirtificate.pdf";
import apScholar from "../../assets/AP Scholar with Distinction Award.pdf";
		...
		<>
			<header className="resume">
				...
				<p className="location">
					10208 Echoridge Dr., Austin, Texas 78750
					<br />
					Email:{" "}
					<a href="mailto:lai.huy.075@gmail.com">
						lai.huy.075@gmail.com
					</a>
					<br />
					Phone: <a href="tel:5122107909">+1 (512)-210-7909</a>
					<br />
					<a href="https://www.linkedin.com/in/huy-lai-93a2b4211">
						LinkedIn
					</a>
				</p>
			</header>
			...
			<p className="resume">
				Seeking an internship to apply what I have learned and to gain
			...
			<p className="resume">
				<b>Simulation Team Lead</b>, Texas A&M University RoboMasters
			</p>
			<p className="resume">January 2022 - May 2022</p>
			<ul className="resume">
				<li>Implemented a simulation environment using Unity.</li>
				<li>
					Integrated Computer Vision software into the simulation
					environment.
				</li>
				<li>
					Communicated current simulation issues with team members and
					provided practical solutions.
				</li>
			</ul>

			<p className="resume">
				<b>Lifeguard</b>, City of Austin Parks and Recreation Department
			</p>
			<p className="resume">Summer 2018, Summer 2021</p>
			<ul className="resume">
				<li>Promoted water safe habits to patrons.</li>
				<li>
					Proactively search for and prevent life-threatening dangers.
				</li>
